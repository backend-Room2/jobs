        ...
        <div class="card bg-light border-0">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-10 position-relative overflow-hidden">
              <img src="/assets/img/jobs/{{$job->image}}"
                alt="" class="card-img"
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              <div class="mb-4 text-center py-2">
                <h2 class="fw-bold bg-light card-header"> {{$job->jobTitle}}</h2>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Salary From:</span> {{$job->salaryFrom}}$
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Salary To:</span> {{$job->salaryTo}}$
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">published:</span> @if($job->published ==1) yes @else no @endif
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">
                  Category_Name:
                 </span>  {{$job->category->category_name}}
                </p>
              </div>
